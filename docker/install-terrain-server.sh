...
if [ ! -f $archive ]; then
	...
	wget --no-verbose -O $archive "https://github.com/COVISART/cesium-terrain-server/archive/${checkout}.tar.gz"
fi
...
CTS_DIR=$GOPATH/src/github.com/COVISART/cesium-terrain-server
mkdir -p $CTS_DIR
